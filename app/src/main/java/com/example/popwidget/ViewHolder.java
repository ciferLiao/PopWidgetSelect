...
public class ViewHolder extends RecyclerView.ViewHolder {
    ...
    public void setNormalSingleContent(ViewHolder holder,BaseSelect t){
        holder.setText(R.id.tv_content, t.getName())
                .setTextColor(R.id.tv_content, ContextCompat.getColor(holder.itemView.getContext(), getColorByType(t)));
    }

    public void setNormalMutipleContent(ViewHolder holder,BaseSelect t){
        holder
                .setText(R.id.tv_content, t.getName())
                .setTextColor(
                        R.id.tv_content,
                        ContextCompat.getColor(
                                holder.itemView.getContext(), getColorByType(t)));

        holder.setBackgroundRes(R.id.iv_bg,t.isSelect() ? R.mipmap.action_pre : R.mipmap.action_nor);
    }

    public @ColorRes
    int getColorByType(BaseSelect t){
        if(t.isEnable()){
            return R.color.color_999;
        }else if(t.isSpecial()){
            return R.color.c_E02020;
        }else if(t.isSelect()){
